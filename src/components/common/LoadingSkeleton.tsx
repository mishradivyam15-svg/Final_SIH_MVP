  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="rounded-lg border border-ink-300/40 bg-white p-4 shadow-card">
...
export function GraphSkeleton() {
  return (
    <div className="flex h-72 w-full items-center justify-center rounded-lg border border-ink-300/40 bg-surface-subtle">
